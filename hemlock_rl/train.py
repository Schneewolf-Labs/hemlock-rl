...
Wires jing.GRPOLoss + grimoire.GrimoireTrainer around HemlockExecutionReward.
...
from jing import GRPOLoss, tokenize_grpo
...
def parse_args():
    ...
    parser.add_argument("--batch-size", type=int, default=1, help="Prompts per step (completions = this * G)")
